...
<input type="number" className="form-control inputshadowGender" onChange={handel_lcds}   placeholder="lcds " aria-label="First Name" aria-describedby="basic-addon1"/>
</div>

<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"200px"}}>Date</span>
<input type="date" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_data} id="dateofbirth"/>
</div>


<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"200px"}}>Night Time Support</span>
<input type="date" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_night_time_support} id="dateofbirth"/>
</div>
...
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_level_of_understand} placeholder="level of understand " id="dateofbirth"/>
...
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_comunication} placeholder="comunication " id="dateofbirth"/>
...
<input type="text" className="form-control inputshadowGender" onChange={handel_expressing_sexuality}  placeholder="expressing_sexuality" aria-label="First Name" aria-describedby="basic-addon1"/>
</div>
...
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_breathing} placeholder="breathing" id="dateofbirth"/>
...
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_mental_health} placeholder="mental health" id="dateofbirth"/>
...
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_spiritual_and_culture_wellbeing} placeholder="spiritual and culture wellbeing" id="dateofbirth"/>
...
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_mobility} placeholder="mobility" id="dateofbirth"/>
...
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_frequency} placeholder="frequency" id="dateofbirth"/>
...
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_end_og_life_preference} placeholder="end of life preference" id="dateofbirth"/>
