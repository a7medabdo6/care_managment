...
/* end modle code  */
    ...
    const {isLoading,mutate:SubmitEditeCarePlant,isError,error:handelerror,refetch} =  useEditeCarePlanApi()
    const {EditeCarePlanData,error} = useSelector(state => state.EditeCarePlanDataSlice)
    console.log(EditeCarePlanData);
//     useEffect(()=>{
...
const [clientId,setclientId]=useState()
    ...
    const [end_og_life_preference,setend_og_life_preference]=useState(custmerData?.breathing)
...
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>Client Name</span>
...
<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>Worker</span>
...
<div class="input-group m-2 ">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>lcds </span>
<input type="number" className="form-control inputshadowGender" onChange={handel_lcds}   placeholder="lcds " value={lcds} aria-label="First Name" aria-describedby="basic-addon1"/>
</div>

<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>Date</span>
<input type="date" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_data} value={date} id="dateofbirth"/>
</div>


<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>Night Time Support</span>
<input type="date" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_night_time_support} value={night_time_support} id="dateofbirth"/>
</div>
...
<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>level of understand</span>
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_level_of_understand} value={level_of_understand} id="dateofbirth"/>
...
<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>comunication</span>
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_comunication} value={comunication} placeholder="comunication " id="dateofbirth"/>
...
<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>emotional support</span>
<input type="text" name="dateofbirth" className="form-control inputshadowGender" onChange={handel_emotional_support} value={emotional_support} placeholder="emotional support" id="dateofbirth"/>
...
<div class="input-group m-2 ">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>expressing sexuality</span>

<input type="text" className="form-control inputshadowGender" onChange={handel_expressing_sexuality} value={expressing_sexuality} placeholder="expressing_sexuality" aria-label="First Name" aria-describedby="basic-addon1"/>
</div>
...
<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>breathing</span>
<input type="text" name="dateofbirth" className="form-control inputshadowGender" value={breathing} onChange={handel_breathing} placeholder="breathing" id="dateofbirth"/>
...
<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>mental health</span>
<input type="text" name="dateofbirth" className="form-control inputshadowGender" value={mental_health} onChange={handel_mental_health} placeholder="mental health" id="dateofbirth"/>
...
<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>SCW</span>

<input type="text" name="dateofbirth" className="form-control inputshadow" value={spiritual_and_culture_wellbeing} onChange={handel_spiritual_and_culture_wellbeing} placeholder="spiritual and culture wellbeing" id="dateofbirth"/>
...
<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>mobility</span>

<input type="text" name="dateofbirth" className="form-control inputshadowGender" value={mobility} onChange={handel_mobility} placeholder="mobility" id="dateofbirth"/>
...
<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>frequency</span>
<input type="text" name="dateofbirth" className="form-control inputshadowGender" value={frequency} onChange={handel_frequency} placeholder="frequency" id="dateofbirth"/>
...
<div class="input-group m-2">
<span className="input-group-text spantxt" id="basic-addon1" style={{width:"160px"}}>end of life preference</span>
<input type="text" name="dateofbirth" className="form-control inputshadow" value={end_og_life_preference} onChange={handel_end_og_life_preference} placeholder="end of life preference" id="dateofbirth"/>
...
<div className=' title d-flex justify-content-start text-center ms-2 mt-2 ' style={{}}>
...
<div class="input-group ms-2 mb-3   " style={{height:"191px" ,overflowY:"scroll",width:"95%"}}>
